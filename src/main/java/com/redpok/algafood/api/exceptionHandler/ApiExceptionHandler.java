...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, HttpHeaders headers, HttpStatus status, WebRequest request){
        ...
        String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s', que é"
                            + " de um tipo inválido, Corrija e informe um valor compatível com o tipo %s.", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName());
    ...
    private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
        String detail = String.format("A propriedade '%s' não é uma propriedade válida.", path);
    ...
    public ResponseEntity<?> handleTratarEntidadeNaoEncontrada(
        ...
        /*Problem problem = Problem.builder()
                .status(status.value())
                .type("https://algafood.com.br/api/entidade-nao-encontrada")
    ...
    public ResponseEntity<?> handleTratarNegocio(
    ...
    public ResponseEntity<?> handleTratarEntidadeEmUso(
